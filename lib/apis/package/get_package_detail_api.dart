...
class GetPackageDetailApi extends Api {
  String url = '${AppConfig.getApiUrl}/package';

  Future<ResultApi> request(String packageId) async {
    url += '/$packageId';
    ...
    try {
      ...
      if (resultApi.statusCode == 200) {
        var data = GetPackageDetailResponse.fromJson(responseBody);
